...
import static net.Stream.*;
import static net.Stream.EStreamControlMessage.*;
...
public final class EStreamControlMessageMap {
	...
	static {
		...
		map(k_EStreamControlVideoEncoderInfo_VALUE, CVideoEncoderInfoMsg.class);
		//map(k_EStreamControlSetTargetBitrate_VALUE, CSetTargetBitrate.class);
